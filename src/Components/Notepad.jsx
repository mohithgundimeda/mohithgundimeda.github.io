...
export default function Notepad({ closeWindow, minimizeWindow, zIndex, onFocus, minimized }) {
  const isMobile = useIsMobile();
  const [text, setText] = useState("");

  const DEFAULT_POSITION = isMobile ? { top: 0, left: 0 } : { top: 50, left: 300 };
    ...
    >
      <div className={styles.projectsHeader} onMouseDown={startMove}>
        <div className={styles.frameIdentity}>
          <img src="/Notepad.png" alt="Notepad" className={styles.frameIcon} />
          <p className={styles.frameText}>Notepad</p>
        </div>
      ...
      <div className={styles.NotepadContentContainer} style={screenWidthEdit}>
             <textarea
                value={text}
